                                    ...
                                    <div class="col-lg-9">
                                        @if ($lists->status == 'مفتوحة')
                                            <form class="new-added-form"
                                                action="{{ url('boursier/clotureReclamation', $lists->id) }}"
                                                method="POST">
                                                @method('PUT')
                                                @csrf
                            ...
                            <div class="card-body">
                                {{-- @foreach ($responses as $response)
                                    @if ($response->id_user == Auth::user()->id)
                                        <div class="row mb-2">
                                            <div class="col-md-6 offset-6 bg-green rounded-pill pt-2 pb-2"
                                    ...
                                    @else
                                        <div class="row mt-3  mb-3">
                                            <div class="col-md-6  bg-info rounded-pill pt-2 pb-2">
                                                {{ $response->message }}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="col-lg-4 ">
                                        @if ($lists->status == 'مغلقة')
                                            <a class="btn bg-gray btn-sm"
                                                href="{{ url('/boursier/reclamationArchivees') }}">
