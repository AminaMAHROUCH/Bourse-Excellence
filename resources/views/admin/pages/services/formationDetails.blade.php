                ...
                <div class="card-body">
                    <div class="row">
                        <table class="table table-hover  mr-5">
                            <tr>
                                <th style="width: 20% !important">اسم التكوين</th>
                                <td class="pr-5 "> <input class="w-100" value="{{ $formation->titre_formation }}"
                                        readonly> </td>
                            </tr>
                            <tr>
                                <th style="width: 20% !important">نوع الدورة التكوينية</th>
                                <td class="pr-5 "> <input class="w-100" value="{{ $formation->type }}" readonly> </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pr-5 "> <input class="w-100" value="{{ $formation->debut }}" readonly></td>
                            </tr>
                            <tr>
                                <th style="width: 20% !important">إلى</th>
                                <td class="pr-5 "> <input class="w-100" value="{{ $formation->fin }}" readonly></td>
                            </tr>
                            <tr>
