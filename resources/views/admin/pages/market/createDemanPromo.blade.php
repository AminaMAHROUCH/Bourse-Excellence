...
@section('content')
        ...
        <div class="card ml-2 mr-2">
            <div class="card-body ">
                <div class="card-header bg-white">
                    <button class="btn btn-success btn-sm mt-2 mb-1 mr-2 ml-2" data-toggle="modal"
                        data-target="#staticBackdrop" style="float: left !important ; margin-left : -20px !important">اضافة
                    </button>
                </div>
                ...
                <div class="modal-body">
                    <form action="{{ url('boursier/market/store') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 form-group">
                                <label>الوصف :</label>
                                <textarea class="textarea form-control" style="text-align: justify" name="description"
                                    id="form-message" cols="10" rows="4"></textarea>
                            </div>
                            <div class="col-lg-12 col-12 form-group">
                                <label>النوع :</label>
    ...
    @foreach ($markets as $market)
        <div class="modal fade" id="showMarket-{{ $market->id }}" data-backdrop="static" data-keyboard="false"
