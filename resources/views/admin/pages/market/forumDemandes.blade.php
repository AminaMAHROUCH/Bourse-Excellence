                ...
                <div class="pl-5 pr-5">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-10">
                                    <a class="btn bg-gray" data-toggle="modal"
                                        data-target="#showDemande">التفاصيل</i></a>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-white">
                            <form class="new-added-form" action="{{ url('boursier/market/forum/add/' . $demande->id) }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-10">
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="callout callout-warning ">
                                        ...
                                        <hr>
                                        <p style="color : goldenrod !important "> {{ $forum->updated_at }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer bg-white">
                            <div class="row">
                                <div class="col-lg-4 ">
                                    <a class="btn bg-gray btn-sm" href="{{ url('/boursier/market/demandes') }}">
                                        قائمة الطلبات</a>
                                </div>
                                <div class="col-lg-8">
                                    {{ $forums->links() }}
...
<div class="modal fade" id="showDemande" data-backdrop="static" data-keyboard="false" tabindex="-1"
