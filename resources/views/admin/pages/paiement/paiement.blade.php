                                                ...
                                                @foreach ($paniers as $panier)
                                                    <tr role="row">
                                                        ...
                                                        <td style="text-align: center; padding: 20px; font-size:20px;">
                                                            <!--<a href="{{ asset('storage/' . $panier->listes) }}">-->
                                                            <!--    <i class="fas fa-file-csv"><span-->
                                                            <!--            class='badge badge-pill bg-danger'-->
                                                            <!--            style="float: right ;  font-size: 13px;   position: relative; top: -10px;">{{ $panier->code }}</span></i>-->
                                                            <!--</a>-->
                                                            <a href="{{ asset('storage/' . $panier->file_pdf) }}">
                                                                <i class="fas fa-file-pdf text-danger"><span
                                                                        class='badge badge-pill bg-danger'
                                                                        style="float: right ;  font-size: 13px;   position: relative; top: -10px;">{{ $panier->code }}</span></i>
                                                            </a>
                                                            <a href="{{ asset('storage/' . $panier->file_xlsx) }}">
                                                        ...
                                                        @if ($panier->etat == 'مغلوقة')
                                                            @can('panier_action')
                                                                <td class="text-center"><button disabled id="edit" class="btn"
                                                                        style="border: none; background: non;"><i
                                                                            class="fas fa-edit mr-1 text-warning"></i>
                                                                        &nbsp;تعديل</button>
                                                                </td>

                                                                <td>
                                                                    <form
                                                                        action="{{ route('boursier.finance.close', $panier->id) }}"
                                                                        method="post">
                                                                        {{ csrf_field() }}
                                                            ...
                                                            @can('panier_action')
                                                                <td class="text-center">
                                                                    <button id="edit" class="btn"
                                                                        ...
                                                                        <a
                                                                            href="{{ url('boursier/editPanier/' . $panier->id) }}"><i
                                                    ...
                                                    @foreach ($paiments as $paiment)
                                                        <tr role="row">
                                                            ...
                                                            <td style="text-align: center; padding: 20px;">
                                                                ...
                                                                <a href="{{ asset('storage/' . $paiment->demande) }}">
                                                                    <i class="fas fa-list"><span
                                                                            class='badge badge-pill bg-danger'
                                                                            style="float: right ;     position: relative; top: -10px;">{{ $panier->code }}</span></i>
                                                            ...
                                                            @else
                                                                <td class="text-center">
                                                                    <p class="text-success">تم الصرف ل:{{ $paye }}
                                                                    </p>
                                                                    <p class="text-danger">تم رفض: {{ $rejete }}</p>
                                                                    <a
                                                                        href="{{ asset('avisSort/' . $paiment->detail) }}">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content" style="background: white;">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('boursier.addfile', $paiment->id) }}"
                                                                    method="post">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('PUT') }}
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="compte_debiter"
                                                                            class="form-control" id="ribb"
                                                                            hint-class="ribb">
                                                                        <li class="ribb" id="TEST">HKCHKLJCLJL</li>
                                                                    </div>
                                                                    <div class="form-group">
                                                ...
                                                <div class="modal fade" id="examplAdd--{{ $paiment->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content" style="background: white;">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('boursier.AddAvisSort', $paiment->id) }}"
